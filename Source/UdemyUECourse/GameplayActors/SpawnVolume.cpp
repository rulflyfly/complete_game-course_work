...
ASpawnVolume::ASpawnVolume()
{
    ...
    SpawningBox = CreateDefaultSubobject<UBoxComponent>(TEXT("SpawninBox"));
...
/** _Implementation - this way Unreal Engine know that this  it the implementation that we scripted out in C++
 but part of it will also be carried out in blueprints */
