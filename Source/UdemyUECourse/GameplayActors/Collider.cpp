...
ACollider::ACollider()
{
    ...
    Camera->SetupAttachment(GetSpringArm(), USpringArmComponent::SocketName);
    
    OurMovementComponent = CreateDefaultSubobject<UColliderMovementComponent>("OurMovementComponent");
